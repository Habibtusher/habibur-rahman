...
const Contact = () => {
    return (
        <div id="contact" className='backGround pb-5'>
            <div class="container ">
                <h1 className='text-center p-5'>Contact Me</h1>
                <div class="row ">
                    <div class="col-md-7 col-sm-12">
                        <div class="p-3 shadow-lg contactForm ">
                    ...
                    <div class="col-md-5 col-sm-12 text-center p-5">
                        ...
                        <div  class="mt-3">
                        <FontAwesomeIcon  style={{marginRight:'10px',fontSize:'20px '}} icon={faPhone} /><span style={{fontSize:'20px'}}>+8801771531336</span>
                        <br></br>
